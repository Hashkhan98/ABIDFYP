...
\shorttitle{Vision-Based Control of Industrial Robot Arm} %For odd pages
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{document}
\title{Vision-Based Control of Industrial Robot Arm \\ \ \\
{\small Subtitle\\31/10/2019}}
...
To generate the bibliography look at the end of this document in .tex file. To make reference to the bibliography use the commands \verb|\citet{}| and \verb|\citep{}| \citep{hartenberg1955kinematic}. You can combine more than one reference in a single citation \citep{hartenberg1955kinematic, hartenberg1955kinematic}.
